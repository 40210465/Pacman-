...
const headMaterial = new THREE.MeshBasicMaterial({ color: 0xF11212 });                 
...
const mouthMaterial = new THREE.MeshBasicMaterial({ color: 0xF11212 });
...
const HandMaterial = new THREE.MeshBasicMaterial({color:0xBB4242, wireframe: false});
...
// ARMS AND SHOULDERS
const ArmMaterial = new THREE.MeshBasicMaterial({color: 0xBB4242, wireframe: false });
